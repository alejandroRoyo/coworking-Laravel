...
@section('content')
    <h1 style="text-align: center; font-size: 2.5rem; font-weight: bold; margin-bottom: 20px;">Editar Reserva</h1>
    ...
    <form action="{{ route('reservas.update', $reserva->id) }}" method="POST" style="max-width: 600px; margin: 0 auto;">
        ...
        <!-- Nota: La hora de fin se calculará automáticamente en el controlador (por ejemplo, hora de inicio + 1 hora) -->
